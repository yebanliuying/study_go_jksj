...
func List(ctx *gin.Context){
	...
	//rsp, err := global.OrderSrvCln.CartItemList(context.Background(), &proto.UserInfo{
	...
	//
	////请求商品服务获取商品信息
	//goodsRsp, err := global.GoodsSrvCln.BatchGetGoods(context.Background(), &proto.BatchGoodsIdInfo{
	//	Id: ids,
	//})
	//if err!=nil{
...
func New(ctx *gin.Context){
	...
	//_, err := global.GoodsSrvCln.GetGoodsDetail(context.Background(), &proto.GoodInfoRequest{
	//	Id: itemForm.GoodsId,
	//})
	//if err != nil {
